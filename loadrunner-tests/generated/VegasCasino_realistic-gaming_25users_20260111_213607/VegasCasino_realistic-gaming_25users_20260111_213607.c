...
char customer_name[128] = "LoadTest Customer";
char email[256] = "loadtest@vegas-casino.demo";
char company_name[128] = "Vegas LoadTest Corp";
char persona[128] = "LoadTest Persona";
char booth[64] = "LoadRunner_Booth";
int user_balance = 5000;
int cheat_active = 1;

// Vegas Casino API endpoints
char slots_endpoint[256] = "http://localhost:8080/api/slots/spin";
char dice_endpoint[256] = "http://localhost:8080/api/dice/roll";
char blackjack_deal_endpoint[256] = "http://localhost:8080/api/blackjack/deal";
char blackjack_action_endpoint[256] = "http://localhost:8080/api/blackjack/action";
